...
## vars
ACTIVATE_FILE = os.path.abspath( u'%s/../../env/bin/activate' % current_directory )
...
SITE_PACKAGES_DIR = os.path.abspath( u'%s/../../env/lib/python3.8/site-packages' % current_directory )
